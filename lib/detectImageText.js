...
const DEFAULT_TEXT_CHECK_TIMEOUT_MS = 12000;
...
export async function imageContainsReadableText({
  apiKey,
  imageUrl,
  model = process.env.AGNES_MODEL || DEFAULT_VISION_MODEL,
  timeoutMs = Number(process.env.AGNES_IMAGE_TEXT_CHECK_TIMEOUT_MS) || DEFAULT_TEXT_CHECK_TIMEOUT_MS,
}) {
  try {
